            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={accept}
                    className="rounded-lg bg-brand-600 px-4 py-1.5 text-xs font-medium text-white transition-colors hover:bg-brand-700 dark:bg-brand-500 dark:hover:bg-brand-600"
                  >
                    Chấp nhận
                  </button>
                  <button
                    onClick={decline}
                    className="rounded-lg border border-gray-200 px-4 py-1.5 text-xs font-medium text-gray-600 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
                  >
                    Từ chối
                  </button>
                </div>
