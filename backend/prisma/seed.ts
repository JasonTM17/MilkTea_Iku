...
async function main() {
  ...
  await prisma.topping.createMany({
    data: [
      { name: "Trân châu đen", price: 10000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Trân châu trắng", price: 10000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Thạch dừa", price: 8000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Pudding trứng", price: 12000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Kem cheese", price: 15000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Thạch trái cây", price: 10000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Sương sáo", price: 8000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Đào miếng", price: 12000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Shot espresso", price: 15000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Kem whipping", price: 12000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Trân châu hoàng kim", price: 12000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
      { name: "Thạch cà phê", price: 10000, image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=100" },
    ],
  });
  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        basePrice: 48000,
        image: "https://images.unsplash.com/photo-1638176066666-ffb2f013c7dd?w=600&h=600&fit=crop",
        categoryId: traSua.id,
      },
      {
      ...
      },
      {
        ...
        basePrice: 52000,
        image: "https://images.unsplash.com/photo-1525803377221-4a4e2d4e66c8?w=600&h=600&fit=crop",
        categoryId: traSua.id,
        isNew: true,
      },
    ],
  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        basePrice: 48000,
        image: "https://images.unsplash.com/photo-1499638673689-79a0b5115d87?w=600&h=600&fit=crop",
        categoryId: traTraiCay.id,
        isNew: true,
      },
      {
        ...
        basePrice: 42000,
        image: "https://images.unsplash.com/photo-1544252890-c3e95e867d73?w=600&h=600&fit=crop",
        categoryId: traTraiCay.id,
      },
      {
  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        basePrice: 52000,
        image: "https://images.unsplash.com/photo-1625865797083-5e3e6e6e1e0e?w=600&h=600&fit=crop",
        categoryId: dacBiet.id,
        isBestSeller: true,
      },
      {
