...
- Name: api\endpoints.spec.ts >> Newsletter Subscribers API >> GET /api/newsletter/subscribers should reject without auth
- Location: tests\api\endpoints.spec.ts:71:7
