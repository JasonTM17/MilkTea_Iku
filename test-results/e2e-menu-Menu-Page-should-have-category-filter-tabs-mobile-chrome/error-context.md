...
- Name: e2e\menu.spec.ts >> Menu Page >> should have category filter tabs
- Location: tests\e2e\menu.spec.ts:17:7
...
Locator: locator('button:has-text("Tất cả"), a:has-text("Tất cả")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Tất cả"), a:has-text("Tất cả")').first()
