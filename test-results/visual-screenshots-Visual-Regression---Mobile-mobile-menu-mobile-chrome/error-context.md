...
- Name: visual\screenshots.spec.ts >> Visual Regression - Mobile >> mobile menu
- Location: tests\visual\screenshots.spec.ts:48:7
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  92439 pixels (ratio 0.31 of all image pixels) are different.

  Snapshot: mobile-menu.png

Call log:
  - Expect "toHaveScreenshot(mobile-menu.png)" with timeout 5000ms
