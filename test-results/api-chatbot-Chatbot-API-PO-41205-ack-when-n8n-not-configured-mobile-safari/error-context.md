...
- Name: api\chatbot.spec.ts >> Chatbot API >> POST /api/chatbot should return fallback when n8n not configured
- Location: tests\api\chatbot.spec.ts:12:7
