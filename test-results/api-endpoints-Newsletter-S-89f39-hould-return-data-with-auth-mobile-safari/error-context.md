...
- Name: api\endpoints.spec.ts >> Newsletter Subscribers API >> GET /api/newsletter/subscribers should return data with auth
- Location: tests\api\endpoints.spec.ts:62:7
