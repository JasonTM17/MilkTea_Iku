...
- Name: security\security.spec.ts >> Security Tests >> rate limiting should block excessive requests
- Location: tests\security\security.spec.ts:53:7
...
Expected value: 429
Received array: [500, 500, 500, 500, 500, 500, 500, 500]
```
